...
<div class="toolbar">
        ...
        <div class="right">
            ...
            <button class="save-button" type="submit" name="add_category">
...
<div class="container">
    <div class="left">
        ...
        <input required type="text" id="category-name" name="category_name">
    </div>
    <div class="right">
            <div class="img-box">
        ...
        <input required id="file-upload" type="file" name="category_image" style="display: none;"accept="image/*">
    </div>
</div>
</form>
