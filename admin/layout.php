...
<body>
    <?php
        ...
        $admin = get_user_by_id($_SESSION['LOGGED_IN_ADMIN_ID']);
    ?>
    <header>
        <div class="logo">
                ...
                <g id="Th&#225;&#187;&#145;ng k&#195;&#170;" clip-path="url(#clip0_297_245)">
                    <rect width="1440" height="1024" transform="translate(-1176 -31)" fill="#FAFAFA"/>
                        <g id="Group 57">
                            ...
                            <g id="Group">
                                <path id="Vector" d="M1.63638 7.5C1.63638 3.35787 4.93318 0 9 0C13.0668 0 16.3636 3.35787 16.3636 7.5V10.6729L17.9414 14.6905C18.0423 14.9473 18.0116 15.2382 17.8592 15.4672C17.7071 15.6962 17.4533 15.8333 17.1818 15.8333H0.81818C0.546692 15.8333 0.292876 15.6962 0.140678 15.4672C-0.0115362 15.2382 -0.0422998 14.9472 0.0585164 14.6905L1.63638 10.6729V7.5Z" fill="#BDBDBD"/>
                                <path id="Vector_2" d="M5.82935 17.5C6.19069 18.9412 7.46895 20 8.99988 20C10.5308 20 11.8091 18.9412 12.1704 17.5H5.82935Z" fill="#BDBDBD"/>
                            </g>
                        </g>
                    </g>
                </g>
    ...
    <div class="sidebar">
        <ul>
            ...
            <a data-name="quanlysanpham" href="<?=$ADMIN_URL?>/quanlysanpham">
                <div class="border"></div>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a data-name="quanlydanhmuc" href="<?=$ADMIN_URL?>/quanlydanhmuc">
                <div class="border"></div>
            ...
            <a  data-name="quanlynguoidung" href="<?=$ADMIN_URL?>/quanlynguoidung">
                <div class="border"></div>
            ...
            <a data-name="quanlydonhang" href="<?=$ADMIN_URL?>/quanlydonhang">
                <div class="border"></div>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a data-name="quanlydanhgia" href="<?=$ADMIN_URL?>/quanlydanhgia">
                <div class="border"></div>
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        window.addEventListener("load", function() {
            let list =document.querySelector(".sidebar").querySelectorAll("a");
            let url = window.location.href;
            list.forEach(function(element) {
                let name = element.getAttribute('data-name');
                if (url.includes(name) || url.includes(name.replace("quanly", ""))) {
