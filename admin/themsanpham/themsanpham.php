...
.container .right .img-box::before {
      ...
      width: 100%;
      height: 100%;
      background: rgba(0, 0, 0, 0.1); /* Màu đen hơi trong suốt */
    }
.container .right img {
    height: 100%;
}
...
<form method="post" action="<?=$ADMIN_URL?>/quanlysanpham/index.php" enctype="multipart/form-data" >
    <div class="toolbar">
        ...
        <div class="right">
            ...
            <button class="save-button" type="submit" name="add_product">
    ...
    <div class="container">
        <div class="left">
            ...
            <input required type="text" id="product-name" name="product_name" style="grid-column: 1 / 2; grid-row: 2 / 3;">
            <div style="grid-column: 3 / 4; grid-row: 2 / 3;">
                <label for="product-is-special">Đặc biệt</label>
                <input type="checkbox" name="is_special" id="product-is-special"  >
            
            </div>
            <label for="product-description"   style="grid-column: 1 / 2; grid-row: 3 / 4;">Mô tả</label>
            <textarea required name="product_description" id="product-description" style="grid-column: 1 / 4; grid-row: 4 / 5;"></textarea>
            <label for="product-price"  style="grid-column: 1 / 2; grid-row: 5 / 6;">Giá bán</label>
            <input required type="number" name="product_price" id="product-price" min="1000" step="000"  style="grid-column: 1 / 2; grid-row: 6 / 7;">
            <label for="product-cost"  style="grid-column: 2 / 3; grid-row: 5 / 6;">Giá nhập</label>
            <input required type="number" name="product_cost" id="product-cost" min="1000" step="100"  style="grid-column: 2 / 3; grid-row: 6 / 7;">
        ...
        <div class="right">
            ...
            <label  for="file-upload" style="cursor: pointer;">
                ...
                <p>Tải ảnh lên (bắt buộc)</p>
            </label>
            <input required id="file-upload" type="file" name="product_image" style="display: none;" accept="image/*">
        </div>
    </div>
</form>
