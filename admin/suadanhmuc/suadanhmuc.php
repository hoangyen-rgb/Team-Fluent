...
<form method="post" action="<?=$ADMIN_URL?>/quanlydanhmuc/index.php" enctype="multipart/form-data" >
...
<div class="toolbar">
        ...
        <div class="right">
            <a class="cancel-button" href="<?=$ADMIN_URL?>/quanlydanhmuc">
                Hủy

            </a>
            <button class="save-button" type="submit" name="edit_category">
...
<div class="container">
    ...
    <input type="hidden" name="category_id" value="<?=$Id?>">
        ...
        <input required type="text" id="category-name" name="category_name" value="<?=$Name?>">
    </div>
    <div class="right">
            <div class="img-box">
        ...
        <input id="file-upload" type="file" name="category_image" style="display: none;"accept="image/*">
    </div>
</div>
</form>
