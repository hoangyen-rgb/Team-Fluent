...
<main>
    ...
    <div class="container">
        ...
        <div class="profile  whitediv">
            ...
            <div class="diemvahang">
                ...
                <div class="hangthanh">
                    ...
                    <p><?=$RankName?></p>
                    <img src="<?=$IMAGE_DIR?>/<?=$Rank?>.png" alt="">
                    <p>Hạng thành viên</p>
                </div>
            </div>
            <div class="line"></div>
        ...
        <div class="point whitediv">
            ...
            <script>
                ...
                let require_point_div_width = window.getComputedStyle(document.querySelector('.require-point')).width.replace("px", "");
                document.querySelector('.user-point').style.width = Number.parseInt(require_point_div_width * percentage / 100) + "px";
            </script>
            <div class="diemvahang">
                <div class="diem">
                    <p>Điểm mua hàng: <span><?=$Point ? $Point : 0?> / <?=$RequirePoint ? $RequirePoint : 4000?></span></p>
                    <img src="<?=$IMAGE_DIR?>/point.png" alt="">
                </div>

                <div class="hang">
                    <p>Hạng tiếp theo: <span><?=$NextRankName ? $NextRankName : "không có" ?></span></p>
                    <img src="<?=$IMAGE_DIR?>/<?=$NextRank?>.png" alt="">
                </div>
            </div>
    ...
    <div class="hidden-box hidden capnhatsodienthoai">
        <form class="change-phonenumber whitediv" method="post" onsubmit="return check_phone_number();">
    ...
    <div class="hidden-box <?php if(!$order_id) { ?>hidden<?php } ?> lichsudathang" >
        <div class="grid">
            <div class="order-history whitediv">
