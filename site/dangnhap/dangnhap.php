    ...
    <div>
        ...
        <div>
            <form onsubmit="return check_form();" action="" method="post">
                ...
                <label>
                    <p class="input-message" id="pass-message"><?php if($wrong_pass) {echo "Mật khẩu không chính xác";}?></p>
                    <div>
                ...
                <a style="width: fit-content; align-self:self-end; font-weight: 600;" href="<?=$SITE_URL?>/quenmatkhau">Quên mật khẩu?</a>
                <input class="submit" type="submit" value="Đăng nhập">
                <a id="dangky" href="<?=$SITE_URL?>/dangky" class="inline-content">
